...
sidebar_position: 4
description: >-
  Customize the meeting UI of your Android application using Geodocs as your
  guide.
---
...
<head>
  ...
  <meta
    name="description"
    content="Customize the meeting UI of your Android application using Geodocs as your guide."
  />
</head>
